...
- Then, we can use the ```ComplierEffect``` function to acquire the causal effect on the incentivized-recruited group.

```{r}
incen <- ComplierEffect(prop_incen = est_prop_incen,
